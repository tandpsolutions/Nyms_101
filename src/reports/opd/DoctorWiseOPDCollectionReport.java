 ...
 * @author Lenovo
 */
public class DoctorWiseOPDCollectionReport extends javax.swing.JInternalFrame {
     ...
     */
    public DoctorWiseOPDCollectionReport() {
        initComponents();
        addJlabelTotalAmt();
        ...
        class reportPanel extends ReportPanel {
            ...
            public void callView() {
                try {
                    ...
                    String sql = "SELECT o.ref_no,o.v_date,p1.pt_name,o.net_amt,p.cash_amt,p.bank_amt,p.card_amt"
                            + "  FROM opdbillhd o LEFT JOIN payment p ON o.ref_no=p.ref_no LEFT JOIN patientmst p1 ON o.opd_no=p1.opd_no"
