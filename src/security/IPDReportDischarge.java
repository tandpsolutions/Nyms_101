 ...
 * @author Lenovo
 */
public class IPDReportDischarge extends javax.swing.JInternalFrame {
    ...
    private void addReportPanel() {
        class reportPanel extends ReportPanel {
            ...
            public void callView() {
                try {
                    String sql = "SELECT o.ref_no,p.pt_name,o.dis_date,o.paid_amt,o.disc_amt,l.user_name FROM ipdreg o  "
                            + " LEFT JOIN patientmst p ON o.opd_no=p.opd_no LEFT JOIN login l ON o.user_id=l.user_id WHERE ref_no <>'' "
                            + " and o.dis_time_stamp >=? and o.dis_time_stamp <=? AND o.dis_edit_no >0 AND o.ref_no IN (SELECT ref_no FROM ipdreglg)";
                    ...
                    for (int i = 0; i < jTable1.getRowCount(); i++) {
                        jTable1.setValueAt(lb.getData("disc_amt", "ipdreglg", "ref_no", jTable1.getValueAt(i, 0).toString(), 0), i, 3);
                        jTable1.setValueAt(lb.getData("paid_amt", "ipdreglg", "ref_no", jTable1.getValueAt(i, 0).toString(), 0), i, 5);
                    }
