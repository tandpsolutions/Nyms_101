 ...
 * @author Lenovo
 */
public class IPDReportDueBilling extends javax.swing.JInternalFrame {
    ...
    private void addReportPanel() {
        class reportPanel extends ReportPanel {
            ...
            public void callView() {
                try {
                    String sql = "SELECT  o1.v_date,o1.ref_no,p.pt_name,l.user_name,SUM(o1.final_amt) as paid_amt,SUM(o1.disc) as disc_amt FROM ipdreg o "
                            + " LEFT JOIN ipdbilldt o1 ON o.ipd_no=o1.ipd_no LEFT JOIN patientmst p ON o.opd_no=p.opd_no "
                            + " LEFT JOIN login l ON o1.user_id=l.user_id WHERE o1.time_stamp >=? and o1.time_stamp <=? AND o1.edit_no >0 "
                            + " AND o1.ref_no IN (SELECT ref_no FROM ipdbilldtlg) GROUP BY pt_name,o1.ref_no";
                    ...
                    for (int i = 0; i < jTable1.getRowCount(); i++) {
                        jTable1.setValueAt(lb.Convert2DecFmtForRs(lb.isNumber(lb.getData("SUM(disc)", "ipdbilldtlg", "ref_no", jTable1.getValueAt(i, 0).toString(), 0))), i, 3);
                        jTable1.setValueAt(lb.Convert2DecFmtForRs(lb.isNumber(lb.getData("SUM(final_amt)", "ipdbilldtlg", "ref_no", jTable1.getValueAt(i, 0).toString(), 0))), i, 5);
                    }
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Ref No", "Patient Name", "Date", "Disc Amt Before", "Disc Amt After", "Paid Amt Before", "Paid Amt After", "User"
            }
        ) {
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        if (evt.getClickCount() == 2) {
            ...
            if (row != -1) {
                IPDDueBillGeneration opd = new IPDDueBillGeneration();
                opd.setID(jTable1.getValueAt(row, 0).toString());
                HMSHome.addOnScreen(opd, "IPD Due Billing", HMSHome.user_id);
            }
        }
