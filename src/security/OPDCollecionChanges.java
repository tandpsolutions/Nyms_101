 ...
 * @author Lenovo
 */
public class OPDCollecionChanges extends javax.swing.JInternalFrame {
    ...
    private void addReportPanel() {
        class reportPanel extends ReportPanel {
            ...
            public void callView() {
                try {
                    String sql = "SELECT o.ref_no,p.pt_name,o.v_date,o.net_amt,o.disc_amt AS paid_amt,l.user_name FROM opdbillhd o "
                            + " LEFT JOIN patientmst p ON o.opd_no=p.opd_no LEFT JOIN login l ON o.user_id=l.user_id "
                            + " WHERE o.time_stamp >=? and o.time_stamp <=? AND o.edit_no >0";
                    ...
                    while (rsLocal.next()) {
                        ...
                        row.add("0.00");
                        row.add(lb.Convert2DecFmtForRs(rsLocal.getDouble("net_amt")));
                        row.add("0.00");
                    ...
                    for (int i = 0; i < jTable1.getRowCount(); i++) {
                        jTable1.setValueAt(lb.getData("net_amt", "opdbillhdlg", "ref_no", jTable1.getValueAt(i, 0).toString(), 0), i, 3);
                        jTable1.setValueAt(lb.getData("disc_amt", "opdbillhdlg", "ref_no", jTable1.getValueAt(i, 0).toString(), 0), i, 5);
                    }
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Ref No", "Patient Name", "Date", "Bill Amt Before", "Bill Amt After", "Paid Amt Before", "Paid Amt After", "User"
            }
        ) {
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        if (evt.getClickCount() == 2) {
            ...
            if (row != -1) {
                if(jTable1.getValueAt(row, 0).toString().startsWith("OP")){
                    OPDBillGeneration opd = new OPDBillGeneration(jTable1.getValueAt(row, 0).toString().substring(0, 2));
                    opd.setID(jTable1.getValueAt(row, 0).toString());
                    HMSHome.addOnScreen(opd, "OPD Bill Generaion", HMSHome.user_id);
                } else if(jTable1.getValueAt(row, 0).toString().startsWith("PL")){
                    OPDBillGeneration opd = new OPDBillGeneration(jTable1.getValueAt(row, 0).toString().substring(0, 2));
                    opd.setID(jTable1.getValueAt(row, 0).toString());
