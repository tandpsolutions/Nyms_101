 ...
 * @author Lenovo
 */
public class DoctorPatientWiseTotalBill extends javax.swing.JInternalFrame {
     ...
     */
    public DoctorPatientWiseTotalBill(int form_cd) {
        initComponents();
        ...
        class reportPanel extends ReportPanel {
            ...
            public void callView() {
                ...
                try {
                    ...
                    if (jRadioButton1.isSelected()) {
                        sql = "SELECT i.opd_no,i.ipd_no,p.pt_name,i.ref_no,i.admit_date,i.dis_date,a.ac_name, SUM(i1.amount) AS advance,i.disc_amt"
                                + " FROM ipdreg i LEFT JOIN patientmst p ON i.opd_no=p.opd_no LEFT JOIN acntmst a ON i.doc_cd=a.ac_cd "
                                + " LEFT JOIN ipdpaymenthd i1 ON i.ipd_no=i1.ipd_no WHERE i.dis_date is not null  and "
                    ...
                    sql += "  GROUP BY i.ipd_no order by a.ac_cd";
                    ...
                    while (rsLocal.next()) {
                        ...
                        row.add(lb.isNumber(rsLocal.getString("advance")) + lb.isNumber(rsLocal.getString("disc_amt")));
                ...
                try {
                    ...
                    if (jRadioButton1.isSelected()) {
                        sql = "SELECT i.opd_no,i.ipd_no,p.pt_name,i.ref_no,i.admit_date,i.dis_date,a.ac_name, SUM(i1.amount) AS advance,i.disc_amt,"
                                ...
                                + " FROM ipdreg i LEFT JOIN patientmst p ON i.opd_no=p.opd_no LEFT JOIN acntmst a ON i.doc_cd=a.ac_cd "
                                + " LEFT JOIN ipdpaymenthd i1 ON i.ipd_no=i1.ipd_no  LEFT JOIN branchmst b1 ON b1.BRANCH_CD =1 "
                                + " WHERE i.dis_date is not null  and "
                                + " i.dis_date >='" + lb.ConvertDateFormetForDB(jtxtFromDate.getText()) + "' and "
                                + " i.dis_date <='" + lb.ConvertDateFormetForDB(jtxtToDate.getText()) + "'  and ref_opd_no ='' ";
                        sql += " and i.doc_cd in(";
                        int[] array = jTable2.getSelectedRows();
                    ...
                    lb.reportGeneratorWord("ReferanceDoctorBIll.jasper", params, rsLocal);
                } catch (Exception ex) {
            ...
            public void callPreview() {
                try {
                    ...
                    params.put("fromDate", jtxtFromDate.getText());
                    params.put("toDate", jtxtToDate.getText());
                    lb.reportGenerator("ReferanceDoctorBIll.jasper", params, rsLocal, jPanel3);
                } catch (Exception ex) {
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Sr No", "Patient Name", "Voucher #", "OPD No", "IPD No", "D.O.A", "D.O.D", "Total Bill", "Paid Amt", "Discount"
            }
        ) {
