 ...
 * @author Lenovo
 */
public class ConsaltantDoctorItemWiseDetail extends javax.swing.JInternalFrame {
     ...
     */
    public ConsaltantDoctorItemWiseDetail(int form_cd) {
        initComponents();
            ...
            public void callView() {
                ...
                try {
                    ...
                    if (jRadioButton1.isSelected() || jRadioButton3.isSelected()) {
                        String sql = "SELECT b.bill_item_cd,p.pt_name,i1.ref_no,b.bill_item_name,i1.v_date,i1.qty,i1.amt,i1.disc,i1.final_amt,a.ac_name,i1.doc_cd FROM ipdreg i "
                                ...
                                + " LEFT JOIN acntmst a ON i1.doc_cd=a.ac_cd WHERE i1.is_del=0   ";
                        if (!jCheckBox1.isSelected()) {
                            sql += " and i.dis_date >='" + lb.ConvertDateFormetForDB(jtxtFromDate.getText()) + "' and "
                                    + " i.dis_date <='" + lb.ConvertDateFormetForDB(jtxtToDate.getText()) + "' ";
                        } else {
                            sql += " and i1.v_date >='" + lb.ConvertDateFormetForDB(jtxtFromDate.getText()) + "' and "
                    ...
                    if (jRadioButton2.isSelected() || jRadioButton3.isSelected()) {
                        String sql = "SELECT b.bill_item_cd,p.pt_name,i1.ref_no,b.bill_item_name,i.v_date,i1.qty,i1.amount,i1.disc,i1.final_amt,a.ac_name FROM opdbillhd i "
    ...
    private void initComponents() {
        ...
        jCheckBox1.setText("Include W/O Discharge");
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Sr No", "Patient Name", "Voucher #", "Particular", "Date", "Qty", "Amount", "Per.", "Net"
            }
        ) {
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        try {
            String sql = "";
            if (jRadioButton1.isSelected() || jRadioButton3.isSelected()) {
                sql = "SELECT distinct(ac_alias),ac_name FROM acntmst WHERE ac_cd IN"
                        + " (select doc_cd from ipdbilldt where is_del = 0 ";
                if (jCheckBox1.isSelected()) {
                    sql += " and ipd_no in (SELECT ipd_no FROM ipdbilldt WHERE v_date >=? and v_date <=?)";
                } else {
                    sql += " and ipd_no in (SELECT ipd_no FROM ipdreg WHERE dis_date >=? and dis_date <=?)";

                }
                sql += " ) order by ac_name";
                PreparedStatement pstLocal = dataConnection.prepareStatement(sql);
