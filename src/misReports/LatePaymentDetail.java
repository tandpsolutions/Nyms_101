 ...
 * @author Bhaumik
 */
public class LatePaymentDetail extends javax.swing.JInternalFrame {
     ...
     */
    public LatePaymentDetail(JDialog jd, String from, String to) {
        initComponents();
        this.jd = jd;
        dtm = (DefaultTableModel) jTable2.getModel();
        updateIPDList(from, to);
    ...
    private void searchOnTextFieldsOPD() {
        ...
        Print.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                LatePaymentDetail.this.dispose();
                ...
                for (int i = 0; i < jTable2.getRowCount(); i++) {
                    ...
                    row.setPt_name(jTable2.getValueAt(i, 3).toString());
                    row.setTot_amt(jTable2.getValueAt(i, 4).toString());
                    row.setUser(jTable2.getValueAt(i, 5).toString());
                    rows.add(row);
                }
                HashMap params = new HashMap();
                params.put("title", "OPD Late Payment");
    ...
    private void updateIPDList(String from, String to) {
        try {
            String sql = "";
            sql = "SELECT o.ref_no,v_date,p.pt_name,(o.amount) AS disc_amt,l.user_name FROM opdpaymenthd o "
                    ...
                    + " o.v_date <='" + lb.ConvertDateFormetForDB(to) + "' ";
            sql += " and o.ref_no LIKE 'LP%'";
