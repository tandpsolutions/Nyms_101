 ...
 * @author Lenovo
 */
public class PointSystem extends javax.swing.JInternalFrame {
     ...
     */
    public PointSystem(int form_cd) {
        initComponents();
        ...
        class reportPanel extends ReportPanel {
            ...
            public void callView() {
                ...
                try {
                    ...
                    dtm.setRowCount(0);
                    int startIndex = 0;
                    String sql = "SELECT b.bill_item_cd,p.pt_name,b.bill_item_name,SUM(i1.qty) AS qty,b.point_charge,"
                            + " (sum(i1.qty)*b.point_charge) AS tot_point,a.ac_name,i1.doc_cd FROM ipdreg i LEFT JOIN ipdbilldt i1 ON i.ipd_no=i1.ipd_no "
                    ...
                    while (rsLocal.next()) {
                        ...
                        row.add(rsLocal.getString("point_charge"));
                        row.add(lb.isNumber(rsLocal.getString("tot_point")));
                        dtm.addRow(row);
                        j++;
                    }
                    addTotal(startIndex);
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Sr No", "Patient Name", "Particular", "Qty", "Point", "TotalPoint"
            }
        ) {
