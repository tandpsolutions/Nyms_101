 ...
 * @author Lenovo
 */
public class DischargeList extends javax.swing.JInternalFrame {
     ...
     */
    public DischargeList(int form_cd) {
        initComponents();
...
//        add(new JScrollPane(jTable1), BorderLayout.CENTER);
    ...
    private void initComponents() {
        ...
        if (jTable1.getColumnModel().getColumnCount() > 0) {
            jTable1.getColumnModel().getColumn(6).setHeaderValue("Ward Name");
            jTable1.getColumnModel().getColumn(7).setHeaderValue("Bed No");
            jTable1.getColumnModel().getColumn(12).setHeaderValue("Bill");
            jTable1.getColumnModel().getColumn(13).setHeaderValue("Advance");
            jTable1.getColumnModel().getColumn(14).setHeaderValue("Refund");
            jTable1.getColumnModel().getColumn(15).setHeaderValue("Due");
        }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (checkRight(28)) {
            int row = jTable1.getSelectedRow();
            if (row != -1) {
                IPDDayWiseBilling ipd = new IPDDayWiseBilling(null, true, jTable1.getValueAt(row, 3).toString());
