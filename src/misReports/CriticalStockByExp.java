 ...
 * @author nice
 */
public class CriticalStockByExp extends javax.swing.JInternalFrame {
...
//            lb.displayQuickForm(jTable1.getValueAt(jTable1.getSelectedRow(), jTable1.getColumnCount()-1).toString());
    ...
    private void makeQuery() throws SQLException {
        ...
        sql += " and month(m.exp_date)=month('" + lb.ConvertDateFormetForDB(jtxtFromDate.getText()) + "')";
        sql += " and YEAR(m.exp_date)=YEAR(CURRENT_DATE)";
